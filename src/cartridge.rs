...
impl Cartridge {
    pub fn from_bytes(data: Vec<u8>, save_path: Option<path::PathBuf>) -> Result<Self, &'static str> {
        ...
        Ok(Self {
            ...
            mbc: match (data[0x147], data[0x148], data[0x149]) {
                ...
                (0x03, 0x04, 0x02) => Box::new(MBC1::new(data, save_path)),
                (0x13, 0x05, 0x03) => Box::new(MBC3::new(data, save_path)),
    ...
    pub fn from_path(cartridge_path: path::PathBuf) -> Result<Self, &'static str> {
        ...
        Self::from_bytes(data, Some(cartridge_path.with_extension("gbsave")))
    }
